package bunny.sdk.bunnyapiclient.storagezone;
...
public class StoragezoneGetResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     * The Items property
     */
    private java.util.List<StorageZone> items;
    /**
     * The TotalItems property
     */
    private Integer totalItems;
    /**
     * Instantiates a new {@link StoragezoneGetResponse} and sets the default values.
     */
    ...
    public static StoragezoneGetResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("Items", (n) -> { this.setItems(n.getCollectionOfObjectValues(StorageZone::createFromDiscriminatorValue)); });
     ...
     * @return a {@link java.util.List<StorageZone>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<StorageZone> getItems() {
        return this.items;
    }
    /**
     ...
     */
    public void setItems(@jakarta.annotation.Nullable final java.util.List<StorageZone> value) {
        this.items = value;
    }
    /**

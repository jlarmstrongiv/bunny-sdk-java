package bunny.sdk.bunnyapiclient.shield.waf.customrules.item;

import bunny.sdk.bunnyapiclient.models.shield.GetCustomWafRulesResponse;
...
public class WithShieldZoneItemRequestBuilder extends BaseRequestBuilder {
    ...
    public WithShieldZoneItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/shield/waf/custom-rules/{shieldZoneId}{?page,perPage}", pathParameters);
    }
    /**
     * Instantiates a new {@link WithShieldZoneItemRequestBuilder} and sets the default values.
    ...
    public WithShieldZoneItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/shield/waf/custom-rules/{shieldZoneId}{?page,perPage}", rawUrl);
    }
    /**
    ...
    public GetCustomWafRulesResponse get() {
        return get(null);
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public GetCustomWafRulesResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("401", UnauthorizedResult::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, GetCustomWafRulesResponse::createFromDiscriminatorValue);
    }
    /**

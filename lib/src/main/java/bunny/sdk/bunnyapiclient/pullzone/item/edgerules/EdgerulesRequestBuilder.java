package bunny.sdk.bunnyapiclient.pullzone.item.edgerules;

import bunny.sdk.bunnyapiclient.pullzone.item.edgerules.addorupdate.AddOrUpdateRequestBuilder;
import bunny.sdk.bunnyapiclient.pullzone.item.edgerules.item.WithEdgeRuleItemRequestBuilder;
...
public class EdgerulesRequestBuilder extends BaseRequestBuilder {
    ...
    /**
     * Gets an item from the bunny.sdk.BunnyApiClient.pullzone.item.edgerules.item collection

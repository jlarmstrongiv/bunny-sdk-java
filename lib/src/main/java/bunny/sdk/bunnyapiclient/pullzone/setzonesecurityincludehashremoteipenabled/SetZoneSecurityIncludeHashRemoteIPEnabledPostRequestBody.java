...
public class SetZoneSecurityIncludeHashRemoteIPEnabledPostRequestBody implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link SetZoneSecurityIncludeHashRemoteIPEnabledPostRequestBody} and sets the default values.
     */
     ...
     * @return a {@link SetZoneSecurityIncludeHashRemoteIPEnabledPostRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static SetZoneSecurityIncludeHashRemoteIPEnabledPostRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {

package bunny.sdk.bunnyapiclient.dnszone.item.records;
...
public class RecordsPutRequestBody implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<RecordsPutRequestBodyEnviromentalVariables> enviromentalVariables;
    /**
     * The Flags property
     */
    ...
    /**
     * Instantiates a new {@link RecordsPutRequestBody} and sets the default values.
     */
     ...
     * @return a {@link RecordsPutRequestBody}
     */
    @jakarta.annotation.Nonnull
    public static RecordsPutRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a {@link java.util.List<RecordsPutRequestBodyEnviromentalVariables>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<RecordsPutRequestBodyEnviromentalVariables> getEnviromentalVariables() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("EnviromentalVariables", (n) -> { this.setEnviromentalVariables(n.getCollectionOfObjectValues(RecordsPutRequestBodyEnviromentalVariables::createFromDiscriminatorValue)); });
     ...
     */
    public void setEnviromentalVariables(@jakarta.annotation.Nullable final java.util.List<RecordsPutRequestBodyEnviromentalVariables> value) {

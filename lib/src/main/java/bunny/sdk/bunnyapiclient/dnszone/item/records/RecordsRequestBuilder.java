...
import bunny.sdk.bunnyapiclient.dnszone.item.records.item.RecordsItemRequestBuilder;
import bunny.sdk.bunnyapiclient.models.dnszone.DnsRecord;
...
public class RecordsRequestBuilder extends BaseRequestBuilder {
    /**
     * Gets an item from the bunny.sdk.BunnyApiClient.dnszone.item.records.item collection

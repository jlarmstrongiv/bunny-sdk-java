...
public class VideoLibraryAppleFairPlayDrm implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link VideoLibraryAppleFairPlayDrm} and sets the default values.
     */
    public VideoLibraryAppleFairPlayDrm() {
    ...
    public static VideoLibraryAppleFairPlayDrm createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new VideoLibraryAppleFairPlayDrm();
    }
    /**

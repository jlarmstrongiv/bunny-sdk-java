...
public class GetWafProfilesResponse implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link GetWafProfilesResponse} and sets the default values.
     */
    ...
    public static GetWafProfilesResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {

package bunny.sdk.bunnyapiclient.models.streamvideolibrary;
...
public class VideoLibrary implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private VideoLibraryAppleFairPlayDrm appleFairPlayDrm;
    /**
     ...
     */
    private VideoLibraryGoogleWidevineDrm googleWidevineDrm;
    /**
    ...
    /**
     * Instantiates a new {@link VideoLibrary} and sets the default values.
     */
    public VideoLibrary() {
    ...
    public static VideoLibrary createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a {@link VideoLibraryAppleFairPlayDrm}
     */
    @jakarta.annotation.Nullable
    public VideoLibraryAppleFairPlayDrm getAppleFairPlayDrm() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("AppleFairPlayDrm", (n) -> { this.setAppleFairPlayDrm(n.getObjectValue(VideoLibraryAppleFairPlayDrm::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("GoogleWidevineDrm", (n) -> { this.setGoogleWidevineDrm(n.getObjectValue(VideoLibraryGoogleWidevineDrm::createFromDiscriminatorValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public VideoLibraryGoogleWidevineDrm getGoogleWidevineDrm() {
     ...
     */
    public void setAppleFairPlayDrm(@jakarta.annotation.Nullable final VideoLibraryAppleFairPlayDrm value) {
     ...
     */
    public void setGoogleWidevineDrm(@jakarta.annotation.Nullable final VideoLibraryGoogleWidevineDrm value) {

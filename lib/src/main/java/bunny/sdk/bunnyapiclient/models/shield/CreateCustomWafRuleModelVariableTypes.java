...
public class CreateCustomWafRuleModelVariableTypes implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CreateCustomWafRuleModelVariableTypes} and sets the default values.
     */
    public CreateCustomWafRuleModelVariableTypes() {
    ...
    public static CreateCustomWafRuleModelVariableTypes createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new CreateCustomWafRuleModelVariableTypes();
    }
    /**

package bunny.sdk.bunnyapiclient.compute.script.item.publish.item;
...
public class WithUuItemRequestBuilder extends BaseRequestBuilder {
    ...
    public WithUuItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/compute/script/{id}/publish/{uuid}", pathParameters);
    }
    /**
     * Instantiates a new {@link WithUuItemRequestBuilder} and sets the default values.
    ...
    public WithUuItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/compute/script/{id}/publish/{uuid}", rawUrl);
    }
    /**
     * [PublishComputeScript API Docs](https://docs.bunny.net/reference/computeedgescriptpublic_publish)
     * @param body The request body
     */
    public void post(@jakarta.annotation.Nonnull final WithUuPostRequestBody body) {
        post(body, null);
    }
    /**
     * [PublishComputeScript API Docs](https://docs.bunny.net/reference/computeedgescriptpublic_publish)
     ...
     */
    public void post(@jakarta.annotation.Nonnull final WithUuPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final WithUuPostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final WithUuPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);

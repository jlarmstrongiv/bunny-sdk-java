...
public class ScriptGetResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     * The Items property
     */
    private java.util.List<Script> items;
    /**
     * The TotalItems property
     */
    private Integer totalItems;
    /**
     * Instantiates a new {@link ScriptGetResponse} and sets the default values.
     */
    ...
    public static ScriptGetResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("Items", (n) -> { this.setItems(n.getCollectionOfObjectValues(Script::createFromDiscriminatorValue)); });
     ...
     * @return a {@link java.util.List<Script>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<Script> getItems() {
        return this.items;
    }
    /**
     ...
     */
    public void setItems(@jakarta.annotation.Nullable final java.util.List<Script> value) {
        this.items = value;
    }
    /**

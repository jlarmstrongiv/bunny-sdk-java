...
public class VideoResolutionsInfoResult implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private VideoResolutionsInfoResultData data;
    /**
    ...
    /**
     * Instantiates a new {@link VideoResolutionsInfoResult} and sets the default values.
     */
    ...
    public static VideoResolutionsInfoResult createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public VideoResolutionsInfoResultData getData() {
        return this.data;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("data", (n) -> { this.setData(n.getObjectValue(VideoResolutionsInfoResultData::createFromDiscriminatorValue)); });
     ...
     */
    public void setData(@jakarta.annotation.Nullable final VideoResolutionsInfoResultData value) {
        this.data = value;
    }
    /**

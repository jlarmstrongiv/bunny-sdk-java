package bunny.sdk.streamapiclient.library.item.videos.item.captions;

import bunny.sdk.streamapiclient.library.item.videos.item.captions.item.WithSrclangPathParameterItemRequestBuilder;
...
public class CaptionsRequestBuilder extends BaseRequestBuilder {
    /**
     * Gets an item from the bunny.sdk.StreamApiClient.library.item.videos.item.captions.item collection

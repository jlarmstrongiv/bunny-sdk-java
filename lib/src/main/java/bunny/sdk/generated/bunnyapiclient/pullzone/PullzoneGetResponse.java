package bunny.sdk.generated.bunnyapiclient.pullzone;
...
public class PullzoneGetResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     * The Items property
     */
    private java.util.List<PullZone> items;
    /**
     * The TotalItems property
     */
    private Integer totalItems;
    /**
     * Instantiates a new {@link PullzoneGetResponse} and sets the default values.
     */
    ...
    public static PullzoneGetResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("Items", (n) -> { this.setItems(n.getCollectionOfObjectValues(PullZone::createFromDiscriminatorValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public java.util.List<PullZone> getItems() {
        return this.items;
    }
    /**
     ...
     */
    public void setItems(@jakarta.annotation.Nullable final java.util.List<PullZone> value) {
        this.items = value;
    }
    /**

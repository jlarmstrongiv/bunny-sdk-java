package bunny.sdk.generated.bunnyapiclient.dnszone;

import bunny.sdk.generated.bunnyapiclient.models.dnszone.DnsZone;
...
public class DnszoneGetResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     * The Items property
     */
    private java.util.List<DnsZone> items;
    /**
     * The TotalItems property
     */
    private Integer totalItems;
    /**
     * Instantiates a new {@link DnszoneGetResponse} and sets the default values.
     */
    ...
    public static DnszoneGetResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("Items", (n) -> { this.setItems(n.getCollectionOfObjectValues(DnsZone::createFromDiscriminatorValue)); });
     ...
     * @return a {@link java.util.List<DnsZone>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<DnsZone> getItems() {
        return this.items;
    }
    /**
     ...
     */
    public void setItems(@jakarta.annotation.Nullable final java.util.List<DnsZone> value) {
        this.items = value;
    }
    /**

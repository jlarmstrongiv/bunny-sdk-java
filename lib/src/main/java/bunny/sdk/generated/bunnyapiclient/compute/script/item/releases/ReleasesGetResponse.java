...
import bunny.sdk.generated.bunnyapiclient.models.compute.ScriptRelease;
...
public class ReleasesGetResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     * The Items property
     */
    private java.util.List<ScriptRelease> items;
    /**
     * The TotalItems property
     */
    private Integer totalItems;
    /**
     * Instantiates a new {@link ReleasesGetResponse} and sets the default values.
     */
    ...
    public static ReleasesGetResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("Items", (n) -> { this.setItems(n.getCollectionOfObjectValues(ScriptRelease::createFromDiscriminatorValue)); });
     ...
     * @return a {@link java.util.List<ScriptRelease>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<ScriptRelease> getItems() {
        return this.items;
    }
    /**
     ...
     */
    public void setItems(@jakarta.annotation.Nullable final java.util.List<ScriptRelease> value) {
        this.items = value;
    }
    /**

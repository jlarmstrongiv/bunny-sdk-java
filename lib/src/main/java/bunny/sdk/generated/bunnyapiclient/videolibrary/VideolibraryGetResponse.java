...
public class VideolibraryGetResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     * The Items property
     */
    private java.util.List<VideoLibrary> items;
    /**
     * The TotalItems property
     */
    private Integer totalItems;
    /**
     * Instantiates a new {@link VideolibraryGetResponse} and sets the default values.
     */
    ...
    public static VideolibraryGetResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("Items", (n) -> { this.setItems(n.getCollectionOfObjectValues(VideoLibrary::createFromDiscriminatorValue)); });
     ...
     * @return a {@link java.util.List<VideoLibrary>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<VideoLibrary> getItems() {
        return this.items;
    }
    /**
     ...
     */
    public void setItems(@jakarta.annotation.Nullable final java.util.List<VideoLibrary> value) {
        this.items = value;
    }
    /**

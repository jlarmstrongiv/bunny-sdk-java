package bunny.sdk.generated.bunnyapiclient.abusecase;
...
public class AbusecaseGetResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     * The Items property
     */
    private java.util.List<AbuseCase> items;
    /**
     * The TotalItems property
     */
    private Integer totalItems;
    /**
     * Instantiates a new {@link AbusecaseGetResponse} and sets the default values.
     */
    ...
    public static AbusecaseGetResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("Items", (n) -> { this.setItems(n.getCollectionOfObjectValues(AbuseCase::createFromDiscriminatorValue)); });
     ...
     * @return a {@link java.util.List<AbuseCase>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<AbuseCase> getItems() {
        return this.items;
    }
    /**
     ...
     */
    public void setItems(@jakarta.annotation.Nullable final java.util.List<AbuseCase> value) {
        this.items = value;
    }
    /**

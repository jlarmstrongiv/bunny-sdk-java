package bunny.sdk.generated.bunnyapiclient.statistics;

import bunny.sdk.generated.bunnyapiclient.models.statistics.getstatistics.Statistics;
...
public class StatisticsRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @jakarta.annotation.Nullable
    public Statistics get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        return this.requestAdapter.send(requestInfo, null, Statistics::createFromDiscriminatorValue);
    }
    /**
     * [GetStatistics API Docs](https://docs.bunny.net/reference/statisticspublic_index)
    ...
    public class GetQueryParameters implements QueryParameters {
        ...
        @jakarta.annotation.Nullable
        public Long pullZone;
        @jakarta.annotation.Nullable
        public Long serverZoneId;
        /**
        ...
        public Map<String, Object> toQueryParameters() {
            ...
            allQueryParams.put("loadErrors", loadErrors);
            allQueryParams.put("pullZone", pullZone);
            allQueryParams.put("serverZoneId", serverZoneId);

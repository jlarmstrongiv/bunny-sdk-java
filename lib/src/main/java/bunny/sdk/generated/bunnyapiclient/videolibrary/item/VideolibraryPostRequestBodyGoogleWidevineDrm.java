...
public class VideolibraryPostRequestBodyGoogleWidevineDrm implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link VideolibraryPostRequestBodyGoogleWidevineDrm} and sets the default values.
     */
    public VideolibraryPostRequestBodyGoogleWidevineDrm() {
    ...
    public static VideolibraryPostRequestBodyGoogleWidevineDrm createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new VideolibraryPostRequestBodyGoogleWidevineDrm();
    }
    /**
